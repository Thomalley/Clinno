...
import ValidarUsuario from "./CreaTurnos/ValidarUsuario";
import RegistrarUsuario from "./CreaTurnos/RegistrarUsuario";
...
export default function LoginClinica() {
    ...
    const cerrarSesion = () => {
        ...
        swal("Has cerrado la sesion correctamente!", "En instantes seras redirigido a Inicio", "success");
        ...
        <main>
            <div className="d-flex flex-column align-items-center flex-shrink-0 p-3 text-white bg-dark nav_clinica" >
                <Link to="/adminClinica" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none ">
                    ...
                    <img src={logo} className='logo_clinno_navC' alt="nf" />
                </Link>
                <hr />
                {window.location.pathname.toLowerCase().includes('/soydoctor') ?
                    ...
                    <ul className="nav nav-pills flex-column mb-auto ">
                        ...
                        {/* <li className="nav-item">
                            <button onChange={new_turno()} className="nav-link text-white boton_nav_clinica">turno</button>
                        </li> */}
                        <li>
