          ...
          <div className="contenedor_turno">
            <div className="row">
              <div className="col-12">
                <div className="titleTurn">
                  ...
                  <h6 className="display-4" id="aboveTitle_turn_id">
                    Facil, rapido y en el momento
                  </h6>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="cont_tur_BG">
                  <h3 className="display-6" id="Esp_Tur_Crea">
            ...
            {hasDoctor.doctor === true ? (
              <div className="row">
                <div className="col-12">
                  <div className="cont_tur_BG">
                    <h3 className="display-6" id="Doc_Tur_Crea">
            ...
            <div className="row">
              <div className="col-12">
                <div className="cont_tur_BG">
                  <div>
                    <h3 className="display-6" id="Dia_Tur_Crea">
                      Selecciona el dia:{" "}
                    </h3>
              ...
              <div className="row">
                <div className="col-12">
                  <div className="cont_tur_BG">
                    <h3 className="display-6" id="Hor_Tur_Crea">
                      Horario:{" "}
                    </h3>
                    <select
                      id="Sel_Tur_Crea_Hora"
                      class="form-select"
                      aria-label="Default select example"
                    ...
                    >
                      <option
                        ...
                        disabled
                        selected
                      >{`Horarios disponibles el ${idValue.fecha.replace(
                        "-",
                        "/"
                      )}`}</option>
                      {horariosDispoDoc &&
